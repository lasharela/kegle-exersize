...
describe('program config', () => {
  ...
  it('has all 7 strength exercises in English with sets/reps/ramp', () => {
    ...
    expect(keys).toEqual(['swing','upright_row','goblet_squat','lunge','overhead_press','pushup','bent_row','glute_bridge','kb_deadlift','suitcase_carry','dead_bug','front_plank','side_plank'])
